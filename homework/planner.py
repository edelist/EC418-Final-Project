...
#         """
#         Predict aim point in image coordinates from a batch of images.
#         """
#         x = self._conv(img)
...
class Planner(torch.nn.Module):
    ...
    def predict(self, img):
        """
        Predicts aim point in evaluation mode.
        """
        self.eval()
        with torch.no_grad():
